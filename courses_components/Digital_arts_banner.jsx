...
export default function Banner({data}){
        ...
        <div className="bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl p-6 space-y-4">
          ...
          <div className="flex items-center justify-between text-sm text-slate-500">
            <span className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-gradient-to-br from-red-900 to-slate-700 animate-pulse"></span> Free / low-cost pilot</span>
