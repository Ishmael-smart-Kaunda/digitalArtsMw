...
export default function Deliverables() {
    return(
        <section class="max-w-6xl mx-auto px-6 py-10 grid lg:grid-cols-2 gap-8">
            <div class="p-6 rounded-2xl shadow card-shadow border border-borderColor">
                <p class="text-sm text-indigo-600 font-semibold uppercase">Learning experience</p>
                <h3 class="text-xl text-primaryText font-bold mt-1 ">What it feels like</h3>
                <ul class="mt-4 space-y-3 text-slate-600 text-sm">
                <li class="flex gap-3 items-start text-secondaryText"><span class="text-indigo-500 mt-0.5">•</span><span>Weekly live sessions (evenings) with replays for catch-up.</span></li>
                <li class="flex gap-3 items-start text-secondaryText"><span class="text-indigo-500 mt-0.5">•</span><span>Short challenges after each lesson to lock in skills.</span></li>
                <li class="flex gap-3 items-start text-secondaryText"><span class="text-indigo-500 mt-0.5">•</span><span>Critique rooms — submit work, get targeted feedback.</span></li>
                <li class="flex gap-3 items-start text-secondaryText"><span class="text-indigo-500 mt-0.5">•</span><span>Community co-working sessions for accountability.</span></li>
                </ul>
                <div class="mt-5 rounded-xl border border-dashed border-indigo-200 p-4 bg-bgSpecial4 text-indigo-700 text-sm ">
